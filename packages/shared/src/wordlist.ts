// Curated list of common English words, lowercase, no punctuation.
// Inspired by Monkeytype's `english_200` wordlist (public-domain words).
// Used by both the client (for solo practice / fallback) and the worker
// (when the room creator hasn't supplied custom text).
export const ENGLISH_200: readonly string[] = [
